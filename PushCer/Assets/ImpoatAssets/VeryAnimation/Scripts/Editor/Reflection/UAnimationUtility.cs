...
namespace VeryAnimation
{
    public class UAnimationUtility
    {
        ...
        private Action<AnimationClip> dg_Internal_SyncEditorCurves;
        ...
        public UAnimationUtility()
        {
            ...
            Assert.IsNotNull(dg_Internal_SyncEditorCurves = (Action<AnimationClip>)Delegate.CreateDelegate(typeof(Action<AnimationClip>), null, animationUtilityType.GetMethod("Internal_SyncEditorCurves", BindingFlags.NonPublic | BindingFlags.Static)));
        }
