...
namespace VeryAnimation
{
    ...
    public class OriginalIKCore
    {
        ...
        private GUIContent[] SolverTypeStrings = new GUIContent[(int)SolverType.LimbIK + 1];
        ...
        private GUIContent[] IKSpaceTypeStrings = new GUIContent[(int)OriginalIKData.SpaceType.Total];
        ...
        private void UpdateGUIContentStrings()
        {
            ...
            {
                SolverTypeStrings[i] = Language.GetContent(Language.Help.OriginalIKTypeCcdIK + i);
            }
            for (int i = 0; i < (int)OriginalIKData.SpaceType.Total; i++)
            {
                IKSpaceTypeStrings[i] = Language.GetContent(Language.Help.SelectionOriginalIKSpaceTypeGlobal + i);
            }
        }
        ...
        public void SelectionGUI()
        {
            ...
            {
                EditorGUILayout.BeginHorizontal(RowCount++ % 2 == 0 ? vaw.guiStyleAnimationRowEvenStyle : vaw.guiStyleAnimationRowOddStyle);
                EditorGUILayout.LabelField(Language.GetContent(Language.Help.SelectionIKFixed), GUILayout.Width(50));
                EditorGUI.BeginChangeCheck();
